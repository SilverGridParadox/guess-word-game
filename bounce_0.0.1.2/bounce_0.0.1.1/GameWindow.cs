    ...
    public partial class GameWindow : Form
    {
        ...
        private void keydown(object sender, KeyEventArgs e)
        {
            ...
            if (e.KeyCode.ToString() == "W")
                game.Environment.mainOb.AxisY = -10;
            if (e.KeyCode.ToString() == "S")
                game.Environment.mainOb.AxisY = 10;
            if (e.KeyCode.ToString() == "A")
                game.Environment.mainOb.AxisX = -10;
        ...
        private void keyup(object sender, KeyEventArgs e)
        {
            ...
            if (e.KeyCode.ToString() == "W")
            {
                game.Environment.mainOb.AxisY = 0;
            ...
            if (e.KeyCode.ToString() == "S")
                game.Environment.mainOb.AxisY = 0;
            if (e.KeyCode.ToString() == "A")
                game.Environment.mainOb.AxisX = 0;
            if (e.KeyCode.ToString() == "D")
                game.Environment.mainOb.AxisX = 0;
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
           ...
           // spotting ball
            ...
            e.Graphics.DrawImage(bl.Texture, bl.CoordX, bl.CoordY);
                ...
                e.Graphics.DrawImage(game.InGameBall.Texture,game.Environment.mainOb.CoordX, game.Environment.mainOb.CoordY);
        }
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            game.Environment.Tact(Height, Width);
